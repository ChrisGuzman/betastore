hat = Product.create!(name: "Hat", price: rand(10), image_url: "/images/products/hat.jpg", )
hoodie = Product.create!(name: "Hoodie", price: rand(10), image_url: "/images/products/hoodie.jpg")
iphone_case = Product.create!(name: "iPhone Case", price: rand(10), image_url: "/images/products/iphone_case.jpg")
journal = Product.create!(name: "Journal", price: rand(10), image_url: "/images/products/journal.jpg")
shirt = Product.create!(name: "Shirt", price: rand(10), image_url: "/images/products/shirt.jpg")
sticker = Product.create!(name: "Sticker", price: rand(10), image_url: "/images/products/sticker.jpg")
